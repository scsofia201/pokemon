...
(define (escenario x y d ventana mapa)
  (cond
    ...
    ((= mapa 3) (cond ((> x 591) (llamado 5 y d ventana 3.2))
                      ((> y 490) (llamado 260 10 d ventana 2.1))
                      ((< y 10)  (llamado x 490 d ventana 3.1))(else #t)))
    ((= mapa 3.1) (cond ((> x 591) (llamado 5 y d ventana 3.3))
                        ((< x 5)  (llamado 589 10 d ventana 4.3))
                        ((> y 490)  (llamado x 10 d ventana 3)) (else #t)))
    ((= mapa 3.2) (cond ((< x 5) (llamado 590 y d ventana 3))
                        ((> y 490) (llamado 310 10 d ventana 2.1))
                        ((< y 10)  (llamado x 490 d ventana 3.3)) (else #t)))
    ((= mapa 3.3) (cond ((< x 5) (llamado 590 y d ventana 3.1))
                        ((> y 490) (llamado x 10 d ventana 3.2))(else #t)))
    ((= mapa 4) (cond ((> y 490) (llamado x 5 d ventana 4.2))
                      ((> x 590) (llamado 5 y d ventana 4.1)) (else #t)))
    ((= mapa 4.1) (cond ((> y 490) (llamado x 5 d ventana 4.3))
                        ((< x 5) (llamado 590 y d ventana 4)) (else #t)))
    ((= mapa 4.2) (cond ((< y 5) (llamado x 490 d ventana 4))
                        ((> x 590) (llamado 10 y d ventana 4.3)) (else #t)))
    ((= mapa 4.3)(cond ((> x 558)(llamado 10 450 d ventana 3.1))
                       ((< x 5) (llamado 590 y d ventana 4.2))
                       ((< y 5) (llamado x 490 d ventana 4.1)) (else #t)))) )
